...
urlpatterns = [
    #urls para servicios
    url(
        r'^api/caja/liuidar/deudas/(?P<fecha>[-\w]+)/$',
        viewsets.GenerarDeudas.as_view({'get': 'list'}),
        name='liquidacion-generar_deudas'
    ),
    url(
    ...
    url(
        r'^caja/liquidacion/deudas/$',
        views.DeudasVendorView.as_view(),
