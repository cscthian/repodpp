(function(){
    ...
    angular.module("MagazineApp")
        .controller("PautaDiarioCtrl",  ['$http','uiGridConstants','ngToast', PautaDiarioCtrl]);

    //MagazineCtrl.$inject = ["NgTableParams"];

    function PautaDiarioCtrl($http,uiGridConstants,ngToast){
      var vm = this;
      vm.date = new Date();
      ...
      vm.gridOptions = {
        ...
        exporterPdfHeader: {
            text: "DPP PAUATA DE ENTREGA DIARIOS: "+vm.diario, style: 'headerStyle',
        },
      ...
      $http.get("/api/guide-detalle/lista-tipo/0/")
