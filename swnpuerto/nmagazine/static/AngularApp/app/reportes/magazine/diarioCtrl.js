(function(){
    ...
    angular.module("MagazineApp")
        .controller("DiarioCtrl",  ['$http','uiGridConstants','ngToast', DiarioCtrl]);

    //MagazineCtrl.$inject = ["NgTableParams"];

    function DiarioCtrl($http,uiGridConstants,ngToast){
      var vm = this;
      ...
      vm.gridOptions = {
        ...
        exporterPdfHeader: { text: "Ranking Diarios", style: 'headerStyle' },
      ...
      vm.generar_ranking = function(fecha1, fecha2){
        ...
        $http.get("/api/reportes/diario/"+date1+'/'+date2+'/'+'0')
